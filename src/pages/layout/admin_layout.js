...
function AdminLayout({ children }) {
  return (
    <div className="grid-cols-1 h-screen overflow-hidden w-full bg-[#fefefe] text-gray-800 sm:drawer">
      <div className="navbar col-span-1 md:hidden h-16 bg-white flex justify-between border-b-2 border-gray-200">
        <LayoutHeader />
      </div>
      <div className="col-span-1 h-screen flex w-full">
        ...
        <div className="md:min-w-max w-full min-h-max overflow-y-scroll md:p-6 bg-white">
          {children}
        </div>
      </div>
    </div>
