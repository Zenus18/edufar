...
function AdminNavigateList() {
  ...
  const itemList = [
    ...
    },
    {
      ...
      link: Url.admin_setting,
    },
  ];
  return itemList.map((item) => {
    return (
      <li className="w-full md:my-4 my-2">
        <a
          href={item.link}
...
export default AdminNavigateList;
